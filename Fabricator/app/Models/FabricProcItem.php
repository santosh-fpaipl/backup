...
use App\Models\FabricProcItemColor;

class FabricProcItem extends Model implements HasMedia
{
    use
        Authx,
        HasFactory,
    ...
    */
        ...
        public function fabricProc(){
            return $this->belongsTo(FabricProc::class);
        }

        public function fabricProcItemColors(){
            return $this->hasMany(FabricProcItemColor::class);
        }
    ...
    */
    ...
    public function getMediaConversionName($cSize = 's400')
    {
        switch ($cSize) {
            case 's100':
                return 'fabric-procurement-item-conversion-size-100px';
            default:
                return 'fabric-procurement-item-conversion-size-400px';
        }
    }
    ...
    public function getMediaCollectionName($cName = 'primary')
    {
        switch ($cName) {
            case 'secondary':
                return 'fabric-procurement-item-secondary-images';
            default:
                return 'fabric-procurement-item-primary-image';
        }
    }
