...
class FabricColor extends Model implements HasMedia
{
    use
        Authx,
        HasFactory,
    ...
    */
    ...
    public function getMediaConversionName($cSize = 's400')
    {
        switch ($cSize) {
            case 's100':
                return 'fabric-color-conversion-size-100px';
            default:
                return 'fabric-color-conversion-size-400px';
        }
    }
    ...
    public function getMediaCollectionName($cName = 'primary')
    {
        switch ($cName) {
            case 'secondary':
                return 'fabric-color-secondary-images';
            default:
                return 'fabric-color-primary-image';
        }
    }
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['id', 'fabric_id', 'name', 'slug', 'created_at', 'updated_at', 'deleted_at'])
